...
// ============================================================================
// HomeScreen — still showing hardcoded cards (not wired to form yet)
// ============================================================================
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            // Temporary: test the form by printing to console
            MoodInputForm(
              onSubmit: (score, note) {
                debugPrint('Logged mood: score=$score, note=$note');
              },
            ),
            const Divider(),
            // Hardcoded cards to verify Part 3 still works
