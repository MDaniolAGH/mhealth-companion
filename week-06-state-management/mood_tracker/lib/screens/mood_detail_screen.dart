...
// TODO 6: Import flutter_riverpod and mood_provider
//
...
// TODO 6: Change to ConsumerWidget
class MoodDetailScreen extends StatelessWidget {
  ...
  @override
  // TODO 6: Add WidgetRef ref parameter
              ...
              showDialog(
                ...
                builder: (context) => AlertDialog(
                  ...
                  actions: [
                    ...
                    FilledButton(
                      onPressed: () {
                        // TODO 6: Replace this placeholder with:
                        //   ref.read(moodProvider.notifier).deleteMood(entry.id);
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text(
                              'Not implemented yet — complete TODO 6!',
                            ),
                          ),
                        );
                      },
